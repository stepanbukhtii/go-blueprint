...
type preloaders struct {
	Company  companyPreloader
	UserType userTypePreloader
	User     userPreloader
}

func getPreloaders() preloaders {
	return preloaders{
		Company:  buildCompanyPreloader(),
		UserType: buildUserTypePreloader(),
...
type thenLoaders[Q orm.Loadable] struct {
	Company  companyThenLoader[Q]
	UserType userTypeThenLoader[Q]
	User     userThenLoader[Q]
}

func getThenLoaders[Q orm.Loadable]() thenLoaders[Q] {
	return thenLoaders[Q]{
		Company:  buildCompanyThenLoader[Q](),
		UserType: buildUserTypeThenLoader[Q](),
