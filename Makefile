...
model:
	...
	@DB_USER=$(DB_USER) DB_PASSWORD=$(DB_PASSWORD) DB_HOST=$(DB_HOST) DB_PORT=$(DB_PORT) DB_NAME=$(DB_NAME) DB_SSL_MODE=$(DB_SSL_MODE) \
		go tool github.com/stephenafamo/bob/gen/bobgen-psql -c ./bob.gen.yaml
