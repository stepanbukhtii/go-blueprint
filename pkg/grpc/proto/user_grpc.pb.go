...
const (
	UserService_One_FullMethodName = "/example.UserService/One"
)
...
type UserServiceClient interface {
	One(ctx context.Context, in *OneRequest, opts ...grpc.CallOption) (*User, error)
}
...
func (c *userServiceClient) One(ctx context.Context, in *OneRequest, opts ...grpc.CallOption) (*User, error) {
...
type UserServiceServer interface {
	One(context.Context, *OneRequest) (*User, error)
...
func (UnimplementedUserServiceServer) One(context.Context, *OneRequest) (*User, error) {
